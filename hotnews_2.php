...
<html lang="ja"><head>
<meta charset="utf-8">
<title>ホットニュース詳細｜群馬県高崎市にあるキャバクラ「美学 BIGAKU」</title>
<meta name="description" content="群馬県高崎市にあるキャバクラ「美学 BIGAKU」のホットニュース詳細ページです。【美学 BIGAKU】は高崎市柳川町のアーケード街にあるキャバクラです。キャバクラ「美学 BIGAKU」はガラードグループが運営しています。">
<meta name="keywords" content="キャバクラ,高崎,群馬,美学,ガラードグループ,ホットニュース詳細">
    ...
    <div class="shop_page_hotnews_a">
      <div class="shop_page_hotnews_b">
        <div class="my-gallery_3">
          <figure>
          <a href="img/test_1.jpg" data-size="900x600" title="">
          <div class="trimming_news"><img src="img/test_1.jpg"></div>
          </a>
          </figure>
        </div>
      </div><!--shop_page_hotnews_b-->
      <div class="shop_page_hotnews_c">
        <div class="shop_page_hotnews_ymd">2018.10.20 / 20:20</div>
        <div class="shop_page_hotnews_title">新作モエ・エ・シャンドン入荷中</div>
        <div class="shop_page_hotnews_naiyou">
        期間限定のモエ・エ・シャンドンが入荷中しております。<br />
        <br />
        期間限定ですのでこの機会を逃したら飲めない!?<br />
        </div>
