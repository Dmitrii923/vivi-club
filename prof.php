...
<html lang="ja"><head>
<meta charset="utf-8">
<title>名前｜群馬県高崎市にあるキャバクラ「ヴィヴィクラブ」</title>
<meta name="description" content="群馬県高崎市にあるキャバクラ「ヴィヴィクラブ」の名前ページです。「ヴィヴィクラブ」は高崎市柳川町のアーケード街にあるキャバクラです。キャバクラ「ヴィヴィクラブ」はガラードグループが運営しています。">
<meta name="keywords" content="キャバクラ,高崎,群馬,ヴィヴィクラブ,ガラードグループ,名前">
  ...
  <div class="page_base">
    ...
    <div class="wrapper">
      <div class="element_prof_2">
        ...
        <img src="img/ai-1.jpg" alt="ゆうこ" />
        </div>

        <div class="prof_page_gallery_2">
          <div class="wrapper my-gallery">
            <figure class="element_prof_3"><a href="img/ai-1.jpg" data-size="600x900"><div class="top_cast_box_wrap_2"><img src="img/ai-1.jpg" class="" alt="" /></div></a></figure>
            <figure class="element_prof_3"><a href="img/test_1.jpg" data-size="900x600"><div class="top_cast_box_wrap_2"><img src="img/test_1.jpg" class="" alt="" /></div></a></figure>
            <figure class="element_prof_3"><a href="img/ai-1.jpg" data-size="600x900"><div class="top_cast_box_wrap_2"><img src="img/ai-1.jpg" class="" alt="" /></div></a></figure>
            <figure class="element_prof_3"><a href="img/ai-1.jpg" data-size="600x900"><div class="top_cast_box_wrap_2"><img src="img/ai-1.jpg" class="" alt="" /></div></a></figure>
            <figure class="element_prof_3"><a href="img/ai-1.jpg" data-size="600x900"><div class="top_cast_box_wrap_2"><img src="img/ai-1.jpg" class="" alt="" /></div></a></figure>
            <figure class="element_prof_3"><a href="img/ai-1.jpg" data-size="600x900"><div class="top_cast_box_wrap_2"><img src="img/ai-1.jpg" class="" alt="" /></div></a></figure>
      ...
      <div class="element_prof_2">       
        ...
        <table>
          <tr>
            ...
            <td class="t_td4"><div class="prof_page_name">ゆうこ<span style="font-size:60%;font-weight: 300; padding-left:10px;">（28）</span> </div></td>
          </tr> 
          <tr>
            <td class="t_td3">誕生日</td>
            <td class="t_td4">1990年12月10日</td>
          </tr> 
          <tr>
            <td class="t_td3">血液型</td>
            <td class="t_td4">O型</td>
          </tr>
          <tr>
            <td class="t_td3">出身地</td>
            <td class="t_td4">富山</td>
          </tr>
          <tr>
            <td class="t_td3">資格・特技</td>
            <td class="t_td4">カフェめぐり</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="t_td4">皆で楽しくワイワイ飲みましょう♪</td>
          </tr>                                                                                                    
        </table>
        </div><!--castprof_box-->
        ...
        <div class="prof_page_sns">
          <div class="wrapper_2">
            <div class="element_cast_sns">
            <a href="" target="_blank"><img src="img/cast_instagram.svg"></a>
            </div>
            <div class="element_cast_sns">
            <a href="" target="_blank"><img src="img/cast_twitter.svg"></a>
            </div>
            <div class="element_cast_sns">
            <a href="" target="_blank"><img src="img/cast_blog.svg"></a>
            </div>                        
          </div>
        </div>
    ...
    <div class="castprof_box_blog">
      <div class="prof_page_title">INSTAGRAM</div>
